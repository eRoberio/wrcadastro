...
import 'package:wrcadastro/logic/BO/BO.dart';
import 'package:wrcadastro/logic/DAO/DAO.dart';
      ...
      if (newcustomer != null) {
        dao.insertCustomer(newcustomer as Customer).then((_) {
          dao.db.getConnection().then((conn) {
            String sql = 'select id from wrdbclientes.customer where username = ?;';
